    ...
    <div class="card">
        <div class="card-header">
            <div class="row mb-2 justify-content-end">
                <div class="col-sm-3">
                    <x-search-form-component :url="route('user.index')"/>
                </div>
                <div class="col-sm-2">
                    <x-create-button-component :url="route('user.create')"/>
                </div>
            </div>
        </div>
        <div class="card-body">
                ...
                <table class="table table-hover">
                    ...
                    @forelse($models as $model)
                        <tr>
                            ...
                            <td>
                                <x-show-sm-button-component :url="route('user.show', $model)"/>
                                <x-edit-sm-button-component :url="route('user.edit', $model)"/>
                                <x-delete-sm-button-component :url="route('user.destroy', $model)"/>
                            </td>
                        </tr>
                    @empty
                        <tr>
